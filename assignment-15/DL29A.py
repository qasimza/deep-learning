# DL29A.py CS5173/6073 2023 cheng
# MNIST edge detection training with encoder-decoder
# ImageFilter.BLUR used to produce image-to-image translation
# but the translation is reversed
# in the training set and trained model is saved in DL29Aepoch1.zip
# The application of ImageFilter.BLUR to all training images may take a few minutes. 
# Usage: python DL29A.py
...
for i in range(train_size):
    ...
    target = data.filter(ImageFilter.BLUR)
...
torch.save(model.state_dict(), "DL29Aepoch1.zip")
