...
for i in range(rounds):
    ...
    loss.backward()
    for param in model.parameters():
        param.r = rho * param.r + (1 - rho) * param.grad.square()
        param.data -= eta * param.grad.div(delta + param.r.sqrt())
